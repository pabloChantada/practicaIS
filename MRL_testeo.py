...
def generate_labels(window, x_title):
    '''
    ...
    prediction_button = Button(graph_labels, text="Predecir", width=15, command=generate_prediction)
...
def graph(window, x, y, x_title, y_title, y_pred):
    ...
    generate_labels(window, x_title)                                        # Generamos los labels   
